...
namespace Test.Configuration_Legacy
{
    [TestClass]
    public class UnitTestStaticMethods
    {
        ...
        public void TestInit()
        {
            ...
            ConfigurationManager.Setup(builder);
            Assert.IsTrue(String.IsNullOrEmpty(ConfigurationManager.GetString("ExistingStringKey")));

            builder.Add(new ConfigurationLegacyProvider(assemblyPath));
            ConfigurationManager.Setup(builder);
            Assert.AreEqual("This is a string value", ConfigurationManager.GetString("ExistingStringKey"));
        }
    }
